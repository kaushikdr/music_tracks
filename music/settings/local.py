...
SECRET_KEY = 'f#rbg8$ta5e=k@e!!q4&5_f6i5*(+6+sg3qx3@xmpx832x)l)f'
...
REST_FRAMEWORK = {
   ...
   #  ),
   'EXCEPTION_HANDLER': 'soundtrack.resp.greedy_exception_handler',
...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "musicstatic")
